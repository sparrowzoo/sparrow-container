...
public class AbstractBeanDefinition implements BeanDefinition {
    ...
    @Override public String getBeanClassName() {
    ...
    @Override public TreeMap<Integer, ValueHolder> getConstructorArgsMap() {
        return this.constructorArgsMap;
    }

    @Override public List<ValueHolder> getPropertyValues() {
    ...
    @Override public boolean isInterceptor() {
        return interceptor;
    }
    ...
    @Override public boolean isController() {
        return controller;
    }
